...
class ExoPlayerInstanceManagerImpl private constructor(c: Context) : ExoPlayerInstanceManager {
    ...
    private val MAX_BUFFER = 10000
    private val BUFFER_PLAYBACK = 500
    private val BUFFER_PLAYBACK_RE_BUFFER = 500
   ...
   /* private fun newInstance(): SimpleExoPlayer {
        ...
        val trackSelector: TrackSelector = DefaultTrackSelector(c!!, videoTrackSelectionFactory)
    ...
    private fun newInstance(): SimpleExoPlayer {
        ...
        val videoTrackSelectionFactory = AdaptiveTrackSelection.Factory()
        val trackSelector: TrackSelector = DefaultTrackSelector(c!!, videoTrackSelectionFactory)
        val defaultMaxInitialBitrate = Long.MIN_VALUE

        val defaultBandwidthMeter: DefaultBandwidthMeter = DefaultBandwidthMeter.Builder(c!!)
